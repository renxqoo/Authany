...
sequenceDiagram
    ...
    participant A as AuthAny
    participant B as Target System
...
```json
{
  ...
  "agent_id": "agent_finance_report_v2",
  "target_system": "target_system_code",
  "subject_context": {
    "source": "conversation_channel",
    "subject_type": "channel_user_id",
    "subject_value": "subject_xxx"
...
- 能用 `client_id + agent_id + subject_context + target_system` 换到 delegation token
...
- 审计日志能追踪 client、agent、user、target_system
